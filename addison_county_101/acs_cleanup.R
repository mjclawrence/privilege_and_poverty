...
country_total <- get_acs(geography = "us",
                         ...
                         variables = c("median_hh_income" = "B19013_001",
                                       ...
                                       "insurance_tot_06_male" = "B27001_003",
                                       "insurance_tot_18_male" = "B27001_006",
                                       "insurance_tot_25_male" = "B27001_009",
                                       "insurance_tot_34_male" = "B27001_012",
                                       "insurance_tot_44_male" = "B27001_015",
                                       "insurance_tot_54_male" = "B27001_018",
                                       "insurance_tot_64_male" = "B27001_021",
                                       "insurance_tot_74_male" = "B27001_024",
                                       "insurance_tot_75_male" = "B27001_027",
                                       "insurance_tot_06_fmle" = "B27001_031",
                                       "insurance_tot_18_fmle" = "B27001_034",
                                       "insurance_tot_25_fmle" = "B27001_037",
                                       "insurance_tot_34_fmle" = "B27001_040",
                                       "insurance_tot_44_fmle" = "B27001_043",
                                       "insurance_tot_54_fmle" = "B27001_046",
                                       "insurance_tot_64_fmle" = "B27001_049",
                                       "insurance_tot_74_fmle" = "B27001_052",
                                       "insurance_tot_75_fmle" = "B27001_055",
                                       "insurance_pvt_06_male" = "B27002_004",
                                       "insurance_pvt_18_male" = "B27002_007",
                                       "insurance_pvt_25_male" = "B27002_010",
                                       "insurance_pvt_34_male" = "B27002_013",
                                       "insurance_pvt_44_male" = "B27002_016",
                                       "insurance_pvt_54_male" = "B27002_019",
                                       "insurance_pvt_64_male" = "B27002_022",
                                       "insurance_pvt_74_male" = "B27002_025",
                                       "insurance_pvt_75_male" = "B27002_028",
                                       "insurance_pvt_06_fmle" = "B27002_032",
                                       "insurance_pvt_18_fmle" = "B27002_035",
                                       "insurance_pvt_25_fmle" = "B27002_038",
                                       "insurance_pvt_34_fmle" = "B27002_041",
                                       "insurance_pvt_44_fmle" = "B27002_044",
                                       "insurance_pvt_54_fmle" = "B27002_047",
                                       "insurance_pvt_64_fmle" = "B27002_050",
                                       "insurance_pvt_74_fmle" = "B27002_053",
                                       "insurance_pvt_75_fmle" = "B27002_056",
                                       "insurance_pub_06_male" = "B27003_004",
                                       "insurance_pub_18_male" = "B27003_007",
                                       "insurance_pub_25_male" = "B27003_010",
                                       "insurance_pub_34_male" = "B27003_013",
                                       "insurance_pub_44_male" = "B27003_016",
                                       "insurance_pub_54_male" = "B27003_019",
                                       "insurance_pub_64_male" = "B27003_022",
                                       "insurance_pub_74_male" = "B27003_025",
                                       "insurance_pub_75_male" = "B27003_028",
                                       "insurance_pub_06_fmle" = "B27003_032",
                                       "insurance_pub_18_fmle" = "B27003_035",
                                       "insurance_pub_25_fmle" = "B27003_038",
                                       "insurance_pub_34_fmle" = "B27003_041",
                                       "insurance_pub_44_fmle" = "B27003_044",
                                       "insurance_pub_54_fmle" = "B27003_047",
                                       "insurance_pub_64_fmle" = "B27003_050",
                                       "insurance_pub_74_fmle" = "B27003_053",
                                       "insurance_pub_75_fmle" = "B27003_056",
...
vt_county <- get_acs(geography = "county",
                           ...
                           variables = c("median_hh_income" = "B19013_001",
                                         ...
                                         "race_hispanic" = "B03002_012",
                                         "foreign_born_total" = "B05002_001",
                                         "foreign_born" = "B05002_013",                                      "insurance_tot_06_male" = "B27002_003",
                                         "insurance_tot_06_male" = "B27001_003",
                                         "insurance_tot_18_male" = "B27001_006",
                                         "insurance_tot_25_male" = "B27001_009",
                                         "insurance_tot_34_male" = "B27001_012",
...
vermont_us <- rbind(country_total, vt_state, vt_county, vt_tracts, vt_zipcodes)

vermont_us <- select(vermont_us, !ends_with("M"))


vermont_us_ins <- vermont_us %>%
  mutate(insurance_tot = rowSums(.[35:52]),
         insurance_pvt = rowSums(.[53:70]),
         insurance_pub = rowSums(.[71:88]),
         insurance_none = rowSums(.[89:106]),
         insurance_with = rowSums(.[107:124]),
         insurance_sum = rowSums(.[89:124]))
...
vermont_us_nomoe <- vermont_us %>%
  mutate(poverty_rate_total = round(((poverty_belowE / poverty_totalE) * 100),1),
         ...
         has_health_insurance = round(((rowSums(.[107:124]) / rowSums(.[89:124])) * 100),1)) %>%
  ...
  mutate(short_name = ifelse(grepl("05443", short_name), "Bristol",
                             ifelse(grepl("05456", short_name), "Ferrisburgh",
                                    ifelse(grepl("05469", short_name), "Monkton",
                                           ifelse(grepl("05472", short_name), "New Haven",
                                                  ifelse(grepl("05473", short_name), "North Ferrisburgh",
                                                         ifelse(grepl("05487", short_name), "Starksboro",
                                                                ifelse(grepl("05491", short_name), "Vergennes",
                                                                       ifelse(grepl("05669", short_name), "Roxbury",
                                                                              ifelse(grepl("05734", short_name), "Bridport",
                                                                                     ifelse(grepl("05740", short_name), "East Middlebury",
                                                                                                  ifelse(grepl("05747", short_name), "Granville",
                                                                                                         ifelse(grepl("05748", short_name), "Hancock",
                                                                                                                ifelse(grepl("05753", short_name), "Middlebury",
                                                                                                                       ifelse(grepl("05760", short_name), "Orwell",
                                                                                                                              ifelse(grepl("05766", short_name), "Ripton",
                                                                                                                                     ifelse(grepl("05769", short_name), "Salisbury",
                                                                                                                                            ifelse(grepl("05770", short_name), "Shoreham",
                                                                                                                                                   ifelse(grepl("05778", short_name), "Whiting", short_name))))))))))))))))))) %>%
